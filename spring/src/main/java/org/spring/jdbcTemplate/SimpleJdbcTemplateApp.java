...
import org.spring.jdbcTemplate.dao.CustomerDAO;
import org.spring.jdbcTemplate.model.Customer;
...
public class SimpleJdbcTemplateApp 
{
    public static void main( String[] args )
    {
        ...
        Customer customer4 = new Customer(4, "yiibai4",24);
        Customer customer5 = new Customer(5, "yiibai5",25);
        Customer customer6 = new Customer(6, "yiibai6",26);
